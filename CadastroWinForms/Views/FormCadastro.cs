using CadastroWinForms.Conexao;
using System;
using System.Text.RegularExpressions;
using System.Windows.Forms;

namespace CadastroWinForms.Views
{
    public partial class FormCadastro : Form
    {
        ...
        {
            if (mskCpfCnpj.Text == "   .   .   -" || string.IsNullOrEmpty(mskCpfCnpj.Text))
            {
                MessageBox.Show("Digitos do CPF invalidos!", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                mskCpfCnpj.Focus();
                return false;
            }
            else if (mskCpfCnpj.Text == "  .   .   /    -" || string.IsNullOrEmpty(mskCpfCnpj.Text))
            {
                MessageBox.Show("Digitos do CNPJ invalidos!", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                mskCpfCnpj.Focus();
                return false;
            }
            ...
            else
            {
                ...
                if (anos < 18)
                {
                    MessageBox.Show("Idade menor que 18 anos não permitida", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void MontarTelaPessoaJuridica()
        {
            ...
            dptDataNascimento.Value = DateTime.Now.Date.AddYears(-18);
